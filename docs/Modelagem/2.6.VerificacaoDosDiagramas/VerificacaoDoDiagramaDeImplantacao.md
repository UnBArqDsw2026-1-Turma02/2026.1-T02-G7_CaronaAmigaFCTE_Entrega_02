...
|  1.2   | 23/04/2026 | Adição do vídeo de verificação, e status da verificação           | [Ana Victória Guedes da Costa](https://github.com/navicg), [Gabriel Henrique Rodrigues de Lima](https://github.com/gabrielhrlima), [João Vitor Santos de Oliveira](https://github.com/Jauzimm) e [Karoline Luz da Conceição](https://github.com/KarolineLuz) | [João Marcos Moraes de Andrade](https://github.com/JJOAOMARCOSS) | Inclusão do registro em vídeo da revisão |
