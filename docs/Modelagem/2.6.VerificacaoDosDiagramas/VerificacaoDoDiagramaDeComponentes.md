...
| :----: | :--------: | -------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | :------------------------------------------: |
|  1.0   | 24/04/2026 | Criação do artefato de verificação do Diagrama de Atividades               | [Pedro Henrique Faria da Mota](https://github.com/PhFariaa), [Gustavo Ribeiro Linhares](https://github.com/GustavoLinharesss) | [Nicolas Bomfim Dias Bandeira](https://github.com/NickGehjk) | Estrutura inicial e checklists de verificação |
